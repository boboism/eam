class AssetTransferItemTo < AssetTransferItem
  attr_accessible :asset_allocation_id, :asset_transfer_id, :construction_period_id, :cost_center_id, :created_by_id, :management_department_id, :allocation_propotion, :specific_investment_id, :updated_by_id, :responsible_by, :updated_at, :created_at
